 ...
 *  Mesh tet_mesh, Mesh surface, 
    i) make complex domain
        ...
        cout << "\n[PATCH INFORMATION]: patch_vec.size() = " << patch_vec.size();
        ...
        for (std::size_t i = 0; i < nb_patches; ++i){
            ...
            cout << "\n[PROGRAM INFORMATION]: Wrote filename :" << filename ;
            ...
            infile.close();
            cout << "\ni=" << i;
            cout << "\n\tpatch_vec.at(i).is_valid()  = " << patch_vec.at(i).is_valid()  ;
            cout << "\n\tpatch_vec.at(i).is_empty()  = " << patch_vec.at(i).is_empty()  ;
...
//             cout << "\tpatch_vec.at(i) num facets  = " << distance(patch_vec.at(i).facets_end() , patch_vec.at(i).facets_begin() )  ;
            cout << "\n\tpatch_vec.at(i).number_of_faces   " << patch_vec.at(i).number_of_faces();
            cout << "\n\tpatches.at(i).is_valid()  = " << patches.at(i).is_valid()  ;
            cout << "\n\tpatches.at(i).is_empty()  = " << patches.at(i).is_empty()  ;
            cout << "\n\tpatches.at(i).size_of_facets()  = " << patches.at(i).size_of_facets()  ;
            cout << "\n\tpatches.at(i) num facets  = " << distance(patches.at(i).facets_end() , patches.at(i).facets_begin() )  ;
            cout << "\n\tpatch_vec.at(i).number_of_faces   " << patch_vec.at(i).number_of_faces();
        }
/*
        ...
        cout << "\n[PROGRAM INFORMATION]: Generating domain\n" << flush;                                           // Create domain
...
//                          cell_radius_edge_ratio = 3, cell_size = edge_size_*10  /*0.4*/);
        ...
        cout << "\n[PROGRAM INFORMATION]: Generating tet_mesh\n" << flush;                                         // Mesh generation
        tet_mesh = CGAL::make_mesh_3<C3t3>(domain, /*mesh_*/criteria);
        
        cout << "\n[PROGRAM INFORMATION]: Saving tet_mesh\n" << flush;                                             // Output
        ...
        cout << "\n[PROGRAM INFORMATION]: Program Finished\n" << flush;
        // cout<<"\n[PROGRAM INFORMATION]: Program Finished\n";
        return 0;
    // ii) make mesh
